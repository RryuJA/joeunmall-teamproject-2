...
public class InquiryDAO {
	...
	public void insertInquiryTBL(InquiryVO vo) {
		log.info("INQUIRY_TBL INSERT");
		jdbcTemplate.update(INQUIRY_INSERT, 
							vo.getInquiryIndex(), vo.getUserIndex(), vo.getInquiryDate(), vo.getInquiryCategory(),
							vo.getInquiryState(), vo.getInquiryTitle(), vo.getInquiryContent(), vo.getInquiryAnswer());
	}
